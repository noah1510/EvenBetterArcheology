...
/**
 * A ParsedBlockRegistryContainer is a Block Registry Container that works with the DatagenAPI.
 * This connects the owo registration system with the DatagenAPI and allows generating Blockstates, Models,
 ...
 * All you have to do is create all your Block as static public variables and implement a constructor with no parameters
...
public abstract class ParsedBlockRegistryContainer extends ParsedContainerBase implements BlockRegistryContainer {
    ...
    /**
     * This method is called by the owo registration system after each block was registered.
