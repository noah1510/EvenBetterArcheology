...
import de.sakurajin.evenbetterarcheology.api.AnnotationEngine.Generation.ModelGenerationHelper;
...
public class DatagenModContainer{
    ...
    public final ModelGenerationHelper MODEL_GENERATION_HELPER;
    ...
    public DatagenModContainer(String modid){
        ...
        MODEL_GENERATION_HELPER = new ModelGenerationHelper(MOD_ID, RESOURCE_PACK);
