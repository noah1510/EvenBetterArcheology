...
public class Slab implements BlockGenerationType {
    ...
    public void generate(String name, DatagenModContainer container, String[] textures) {
        switch (textures.length) {
            case 1 -> container.MODEL_GENERATION_HELPER.generateSlab(name, textures[0]);
            case 2 -> container.MODEL_GENERATION_HELPER.generateSlab(name, textures[0], textures[0], textures[1], textures[1]);
            case 4 -> container.MODEL_GENERATION_HELPER.generateSlab(name, textures[0], textures[1], textures[2], textures[3]);
