...
public abstract class FossilBaseCommon extends HorizontalFacingBlock implements BlockItemGenerateable, BlockStateGenerateable {
    ...
    public FossilBaseCommon(Settings settings, String[] textureVariants, int blockItemIndex, Map<Direction, VoxelShape> SHAPE_DIRECTED, String translationSuffixKey) {
        super(settings);
    ...
    public FossilBaseCommon(Settings settings, String[] textureVariants, int blockItemIndex, VoxelShape SHAPE, String translationSuffixKey) {
        this(
            settings,
            textureVariants,
            blockItemIndex,
    ...
    public ItemConvertible generateBlockItem(DatagenModContainer container, String identifier) {
        return container.DATA_GEN_HELPER.generateBlockItem(this, container.settings().rarity(Rarity.UNCOMMON));
    }

    @Override
    public void generateBlockState(DatagenModContainer container, String identifier) {
        container.DATA_GEN_HELPER.generateBlockStateOrientable(identifier, textureVariants);
    }

    @Override
    public void generateItemModel(DatagenModContainer container, String identifier) {
        String texture = container.DATA_GEN_HELPER.getStringID(textureVariants[blockItemIndex], "block");
