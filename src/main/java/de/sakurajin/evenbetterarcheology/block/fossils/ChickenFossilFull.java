...
public class ChickenFossilFull extends FossilCraftableWithEntity {
    ...
    public ChickenFossilFull() {
        super(
            FabricBlockSettings.copyOf(Blocks.SKELETON_SKULL),
            new String[]{
                "fossils/chicken_fossil_0",
                "fossils/chicken_fossil_1",
                "fossils/chicken_fossil_2"
            },
            0,
            CHICKEN_SHAPES_FOR_DIRECTION
        );

        this.craftingParts = new String[]{"chicken_fossil_head", "chicken_fossil_body"};
    }
