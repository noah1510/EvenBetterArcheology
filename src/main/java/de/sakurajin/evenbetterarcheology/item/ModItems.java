...
public class ModItems extends ParsedItemRegistryContainer {
    ...
    public static final Item ARTIFACT_SHARDS = new Item(new OwoItemSettings().rarity(Rarity.UNCOMMON));

    public static final Item UNIDENTIFIED_ARTIFACT = new Item(new OwoItemSettings().rarity(Rarity.UNCOMMON));

    //LOOT ITEMS
    @AssignedName("bomb")
    public static final Item BOMB_ITEM = new BombItem(new OwoItemSettings().rarity(Rarity.COMMON).maxCount(16));
    public static final Item TORRENT_TOTEM = new TorrentTotemItem(new OwoItemSettings().rarity(Rarity.UNCOMMON).maxCount(1).maxDamage(32));
    public static final Item SOUL_TOTEM = new SoulTotemItem(new OwoItemSettings().rarity(Rarity.UNCOMMON).maxDamage(32));
