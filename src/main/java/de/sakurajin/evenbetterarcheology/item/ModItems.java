...
public class ModItems implements ItemRegistryContainer {
    //ITEM ENTRIES-------------------------------------------------------------------------//
    //BRUSHES
    public static final Item IRON_BRUSH = BetterBrushItem.Builder().setBrushingSpeed(8).setMaxDamage(128).build();

    public static final Item DIAMOND_BRUSH = BetterBrushItem.Builder().setBrushingSpeed(6).setMaxDamage(256).build();
