...
public class ModStructure extends Structure {
    ...
    public static final Codec<ModStructure> CODEC = RecordCodecBuilder.<ModStructure>mapCodec(instance ->
    ...
    public ModStructure(Structure.Config config,
    ...
    public Optional<Structure.StructurePosition> getStructurePosition(Structure.Context context) {
        ...
        if (!ModStructure.extraSpawningChecks(context)) {
    ...
    public StructureType<?> getType() {
        return ModStructures.EVENBETTERARCHEOLOGY_STRUCTURES; // Helps the game know how to turn this structure back to json to save to chunks
    }
}
